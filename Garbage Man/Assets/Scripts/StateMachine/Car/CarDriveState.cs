...
{
    public CarDriveState(CarStateMachine currentContext, CarStateFactory carStateFactory) : base (currentContext, carStateFactory)
    {
    ...
    public override void CheckSwitchStates()
    {
        ...
        //If vertical input is less than zero then player wants to break
        if(_ctx.IsBreaking)
        {
            SwitchStates(_factory.Break());
        }

        //If motor torque is negative play is going reverse
